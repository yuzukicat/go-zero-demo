...
type Comment struct {
	...
	PostID    string `protobuf:"bytes,4,opt,name=postID,proto3" json:"postID"`        //postID
}
...
type AddCommentReq struct {
	...
	PostID    string `protobuf:"bytes,3,opt,name=postID,proto3" json:"postID"`        //postID
}
...
func (x *UpdateCommentReq) GetPostID() string {
	if x != nil {
		return x.PostID
	}
	return ""
...
type SearchCommentReq struct {
	...
	PostID    string `protobuf:"bytes,6,opt,name=postID,proto3" json:"postID"`        //postID
}
...
func (x *SearchCommentReq) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SearchCommentReq) GetPostID() string {
	if x != nil {
		return x.PostID
	}
	return ""
...
var file_comment_rpc_comment_proto_rawDesc = []byte{
	...
	0x44, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x44, 0x22,
	...
	0x49, 0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x44,
	...
	0x0a, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x44, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x72,
	...
	0x28, 0x09, 0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x44, 0x22, 0x3f, 0x0a, 0x11, 0x53, 0x65,
